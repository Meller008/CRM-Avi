...
class PackBrows(QDialog):
    ...
    def ui_view_list_article(self):
        self.article_list = article.ArticleList(self, select_variant=True, open_variant=self.pack.article_id())
    ...
    def ui_print_pack_passport(self):
        ...
        html = html.replace("#material#", str(self.pack.material_name()))
