...
INSERT INTO `program_settings_path` VALUES ('Путь корень бирки','//192.168.1.3/бирки'),('Путь корень клиенты','//mybooklive/Public/Программа/Клиенты'),('Путь корень рабочие','//mybooklive/Public/Программа/Штат');
